...
win_bg = pygame.transform.scale(pygame.image.load("img/win.png"), (WIN_WIDTH, WIN_HEIGHT))
lose_bg = pygame.transform.scale(pygame.image.load("img/lose.png"), (WIN_WIDTH, WIN_HEIGHT))
    ...
    if not finish:
        ...
        if score >= 10:
            ...
            if ship.hp <= 0:
                ...
                window.blit(
                font.render(f"Проиграл!!!", 1, (255, 0, 0)), 
                (WIN_WIDTH // 2 - 40, WIN_HEIGHT // 2))
                window.blit(
                font.render(f"Ты пропустил {lost} зефирок на землю", 1, (255, 255, 255)), 
                (WIN_WIDTH // 2 - 140, WIN_HEIGHT // 2 + 30))
